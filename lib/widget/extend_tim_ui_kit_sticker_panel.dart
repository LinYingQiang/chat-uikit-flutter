...
class ExtendStickerPanel extends StatefulWidget {
...
class _EmojiPanelState extends State<ExtendStickerPanel> {
  int selectedIdx = 0;
  ...
  List<Widget> _buildEmojiListWidget(
    ...
    for (var index = 0; index < (customStickerList.length); index++) {
        ...
        child: InkWell(
          ...
          child: Container(
              ...
              decoration: BoxDecoration(
                  color: selectedIdx == index ? widget.lightPrimaryColor : widget.backgroundColor,
      ...
      //list.add(SizedBox(width: 15.w));
    }
    return list;
  }

  Widget _buildEmojiPanel(List<int> textEmojiIndexList, List<int> customEmojiStickerIndexList, List<CustomStickerPackage> customStickerList) {
            ...
            Align(
              ...
              child: SingleChildScrollView(
                child: GestureDetector(
                  ...
                  child: Container(
                      decoration: BoxDecoration(color: themeData.colorScheme.tertiary, borderRadius: BorderRadius.all(Radius.circular(10.sp))),
  ...
  Widget _buildBottomPanel(
    ...
    return Container(
        ...
        child: Row(children: [
          ...
          if ((textEmojiIndexList.contains(selectedIdx) || customEmojiStickerIndexList.contains(selectedIdx)) && widget.sendTextMsg != null)
            ElevatedButton(
                child: Text(TIM_t("发送")),
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: Column(
        children: [
          Container(
            height: (widget.height ?? 248) - (widget.showBottomContainer ? 48 : 0),
            color: widget.backgroundColor,
            padding: widget.panelPadding ?? (widget.isWideScreen ? const EdgeInsets.all(16) : const EdgeInsets.fromLTRB(24, 16, 24, 16)),
            child: _buildEmojiPanel(textEmojiIndexList, customEmojiStickerIndexList, widget.customStickerPackageList)
          ),
